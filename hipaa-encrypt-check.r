...
# Check that all files with ACCESS_APPROVAL = 0 have been encrypted
# and encrypt files if needed
  *Q1 = select DATA_NAME, COLL_NAME where META_DATA_ATTR_NAME = 'ACCESS_APPROVAL' and META_DATA_ATTR_VALUE = '0';
  foreach (*R1 in *Q1) {
    *File = *R1.DATA_NAME;
    *Coll = *R1.COLL_NAME;
