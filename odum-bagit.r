...
#  - August 2010
#  - Requires iRODS 2.4.1 or greater
...
INPUT *BAGITDATA=$"/$rodsZoneClient/home/$userNameClient/sub1", *NEWBAGITROOT=$"/$rodsZoneClient/home/$userNameClient/bagit"
OUTPUT ruleExecOut
