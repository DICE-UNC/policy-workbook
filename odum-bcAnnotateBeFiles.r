...
#
    ...
    *Query2 = select RESC_LOC where DATA_RESC_NAME = '*Resource';
    ...
    # First get the Collection ID (CollID_beFeat) of the image. Fail if the
    # directory doesn't exist
    *Q = select count(COLL_NAME) where COLL_NAME = '*beFeatDir';
    foreach(*R in *Q) {
    *CollID_beFeat = *R.COLL_NAME;
    }
    ...
    *Query3 = select DATA_PATH where COLL_ID = '*CollID_beFeat';
    ...
    # with timestamp and user-id. The unique file will be generated in /tmp
