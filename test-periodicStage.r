periodicStage {
# test-periodicStage.r
# Loop over files in a collection, *Src 
# Put all files into a federated data grid. *Dest
  checkCollInput (*Src);
  checkCollInput (*Dest);
  checkRescInput (*Res, *DestZone);
  *LocalZone = $rodsZoneClient;
      ...
      if (*Coll != *LPath ) {
        ...
        *C1 = substr(*Coll,*Len,*L1);
        ...
        if (*Status >= 0) {
          ...
          msiSetACL("default","own","rwmoore#*LocalZone", *Dest1);
...
INPUT *Res=$"dfc-defaultResc", *DestZone =$"dfcmain", *Src=$"/$rodsZoneClient/home/$userNameClient/stage", *Dest =$"/*DestZone/home/$userNameClient#$rodsZoneClient/archive"
OUTPUT ruleExecOut
