...
# Policy34
# rac-resetIPR.r
# identify the IPR owner and
# remove noncompatible access controls from the archives
...
# remove all other access controls except for GLOBAL_OWNER from *Coll/GLOBAL_ARCHIVES
    *Colt = "*Coll/" ++ GLOBAL_ARCHIVES;
    writeLine ("stdout", "On *Tim,restrict access controls to the IPR owner, *Nam, on collection *Colt");
    writeLine ("stdout", "List persons whose access has been removed");
    writeLine ("stdout", "Name            Number of removals");
