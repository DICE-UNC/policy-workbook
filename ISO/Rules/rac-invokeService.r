...
# Policy61
# rac-invokeService.r
# invoke a service encapsulated in a Docker container through the Discovery Environment
# return values are either registered as metadata or stored as a file in the data grid
  msiGetSystemTime(*Tim, "human");
  writeLine ("stdout", "Message defining the action on *Tim");
