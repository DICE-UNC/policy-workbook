...
# Policy68
# rac-getAIP.r
# Given a handle, Audit-Handle, find the associated AIP.
  msiGetSystemTime(*Tim, "human");
  writeLine ("stdout", "Get an AIP with handle *Han on *Tim");
  *Q1 = select DATA_NAME, DATA_ID, DATA_COLL_ID where META_DATA_ATTR_NAME = "Audit-Handle" and META_DATA_ATTR_VALUE = *Han;
  foreach (*R1 in *Q1) {
    *File = *R1.DATA_NAME;
    ...
    *Daid = *R1.DATA_ID;
    writeLine ("stdout", "  *Col/*File has handle *Han");
  }
