getAIPfromIndex {
  racGlobalSet ();
# Policy72
# rac-getAIPfromIndex.r
# invoke an indexing service encapsulated in a Docker container through the Discovery Environment
# return a list of AIPs that correspond to an input Audit-Description term.
  msiGetSystemTime(*Tim, "human");
  writeLine ("stdout", "Search index for term *Term on *Tim");
...
INPUT *Archive=$"Archive-A", *Term=$"Height"
OUTPUT ruleExecOut 
